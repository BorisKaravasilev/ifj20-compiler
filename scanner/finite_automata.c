...
void init_finite_automata(finite_automataT* fa) {
    ...
    fa->states[1] = STATE_EOF;
    fa->states[2] = STATE_MINUS;
    fa->states[3] = STATE_PLUS;
    fa->states[4] = STATE_MULTIPLICATION;
    fa->states[5] = STATE_DIVISION;
    fa->states[6] = STATE_LEFT_BRACKET;
    fa->states[7] = STATE_RIGHT_BRACKET;
    fa->states[8] = STATE_COMMA;
    fa->states[9] = STATE_COLON;
    fa->states[10] = STATE_COLON_EQUAL;
    fa->states[11] = STATE_EXPLANATION_MARK;
    fa->states[12] = STATE_NOT_EQUAL;
    fa->states[13] = STATE_LEFT_ARROW;
    fa->states[14] = STATE_RIGHT_ARROW;
    fa->states[15] = STATE_LESS_OR_EQUAL;
    fa->states[16] = STATE_GREATER_OR_EQUAL;
    fa->states[17] = STATE_LEFT_CURLY_BRACE;
    fa->states[18] = STATE_RIGHT_CURLY_BRACE;
    fa->states[19] = STATE_SEMICOLON;
    fa->states[20] = STATE_EQUAL;
    fa->states[21] = STATE_DOUBLE_EQUAL;
    fa->states[22] = STATE_LINE_COMMENT_BODY;
    fa->states[23] = STATE_LINE_COMMENT;
    fa->states[24] = STATE_BLOCK_COMMENT_BODY;
    fa->states[25] = STATE_BLOCK_COMMENT_END;
    fa->states[26] = STATE_BLOCK_COMMENT;
    ...
    fa->states[32] = STATE_STRING_LITERAL;
    fa->states[33] = STATE_UNDERSCORE;
    fa->states[34] = STATE_IDENTIFIER;
    fa->states[35] = STATE_INTEGER_LITERAL;
    fa->states[36] = STATE_EXPONENT;
    fa->states[37] = STATE_PLUS_MINUS;
    fa->states[38] = STATE_DECIMAL_NUMBER_NOT_END;
    fa->states[39] = STATE_DECIMAL_LITERAL;
    fa->states[40] = STATE_EXPONENT_LITERAL;
    fa->states[41] = STATE_SLASH;

    // Start state
    fa->start_state = STATE_START;

    // Final states
    fa->final_states[0] = STATE_EOF;
    fa->final_states[1] = STATE_MINUS;
    fa->final_states[2] = STATE_PLUS;
    fa->final_states[3] = STATE_MULTIPLICATION;
    fa->final_states[4] = STATE_DIVISION;
    fa->final_states[5] = STATE_LEFT_BRACKET;
    fa->final_states[6] = STATE_RIGHT_BRACKET;
    fa->final_states[7] = STATE_COMMA;
    fa->final_states[8] = STATE_COLON_EQUAL;
    fa->final_states[9] = STATE_NOT_EQUAL;
    fa->final_states[10] = STATE_LEFT_ARROW;
    fa->final_states[11] = STATE_RIGHT_ARROW;
    fa->final_states[12] = STATE_LESS_OR_EQUAL;
    fa->final_states[13] = STATE_GREATER_OR_EQUAL;
    fa->final_states[14] = STATE_LEFT_CURLY_BRACE;
    fa->final_states[15] = STATE_RIGHT_CURLY_BRACE;
    fa->final_states[16] = STATE_SEMICOLON;
    fa->final_states[17] = STATE_EQUAL;
    fa->final_states[18] = STATE_DOUBLE_EQUAL;
    fa->final_states[19] = STATE_LINE_COMMENT;
    fa->final_states[20] = STATE_BLOCK_COMMENT;
    fa->final_states[21] = STATE_STRING_LITERAL;
    fa->final_states[22] = STATE_UNDERSCORE;
    fa->final_states[23] = STATE_IDENTIFIER;
    fa->final_states[24] = STATE_INTEGER_LITERAL;
    fa->final_states[25] = STATE_DECIMAL_LITERAL;
    fa->final_states[26] = STATE_EXPONENT_LITERAL;
    fa->final_states[27] = STATE_SLASH;

    // --- Rule #0
    fa->rules[0].from_state = STATE_START;
    fa->rules[0].to_state = STATE_EOF;
    fa->rules[0].transition_ranges[0].single_char = EOF;

    // --- Rule #1
    fa->rules[1].from_state = STATE_START;
    fa->rules[1].to_state = STATE_MINUS;
    fa->rules[1].transition_ranges[0].single_char = '-';

    // --- Rule #2
    fa->rules[2].from_state = STATE_START;
    fa->rules[2].to_state = STATE_PLUS;
    fa->rules[2].transition_ranges[0].single_char = '+';

    // --- Rule #3
    fa->rules[3].from_state = STATE_START;
    fa->rules[3].to_state = STATE_MULTIPLICATION;
    fa->rules[3].transition_ranges[0].single_char = '*';

    // --- Rule #4
    fa->rules[4].from_state = STATE_START;
    fa->rules[4].to_state = STATE_LEFT_BRACKET;
    fa->rules[4].transition_ranges[0].single_char = '(';

    // --- Rule #5
    fa->rules[5].from_state = STATE_START;
    fa->rules[5].to_state = STATE_RIGHT_BRACKET;
    fa->rules[5].transition_ranges[0].single_char = ')';

    // --- Rule #6
    fa->rules[6].from_state = STATE_START;
    fa->rules[6].to_state = STATE_COMMA;
    ...
    fa->rules[8].to_state = STATE_COLON_EQUAL;
    ...
    fa->rules[28].to_state = STATE_BLOCK_COMMENT;
    ...
    fa->rules[31].to_state = STATE_STRING_LITERAL;
    ...
    fa->rules[37].to_state = STATE_STRING_LITERAL;
    ...
    // --- Rule #41
    fa->rules[41].from_state = STATE_IDENTIFIER;
    fa->rules[41].to_state = STATE_IDENTIFIER;
    ...
    // --- Rule #42
    fa->rules[42].from_state = STATE_UNDERSCORE;
    fa->rules[42].to_state = STATE_IDENTIFIER;
    ...
    fa->rules[43].to_state = STATE_INTEGER_LITERAL;
    fa->rules[43].transition_ranges[0].from = '0';
    fa->rules[43].transition_ranges[0].to = '9';

    // --- Rule #44
    fa->rules[44].from_state = STATE_INTEGER_LITERAL;
    fa->rules[44].to_state = STATE_INTEGER_LITERAL;
    fa->rules[44].transition_ranges[0].from = '0';
    fa->rules[44].transition_ranges[0].to = '9';

    // --- Rule #45
    fa->rules[45].from_state = STATE_INTEGER_LITERAL;
    ...
    // --- Rule #46
    fa->rules[46].from_state = STATE_INTEGER_LITERAL;
    ...
    fa->rules[47].to_state = STATE_DECIMAL_LITERAL;
    fa->rules[47].transition_ranges[0].from = '0';
    fa->rules[47].transition_ranges[0].to = '9';

    // --- Rule #48
    fa->rules[48].from_state = STATE_DECIMAL_LITERAL;
    fa->rules[48].to_state = STATE_DECIMAL_LITERAL;
    fa->rules[48].transition_ranges[0].from = '0';
    fa->rules[48].transition_ranges[0].to = '9';

    // --- Rule #49
    fa->rules[49].from_state = STATE_DECIMAL_LITERAL;
